...
fast（极速模式）：开启风驰/feas  经可能恢复官方风驰/feas调度 开启后不在按配置文件的参数执行。推荐'风驰适配了的游戏和要启用feas调度'使用<br>
...
Q：恢复了官方调度但发现没有官方调度好用？
A：与官方调度可能存在一些差异，但不会太大

Q：恢复风驰调度可以使用风驰增强模块吗？
A：没测过，但理论...emmmm...我也不知道（）

Q: 其他问题怎么办？
A：群里私聊或发到我的qq邮箱 （qq邮箱 3218633407@qq.com）
